...
#run DFS algorithm on the graph (for graphs with loops use a closed list to avoid infinite loops) :  
DFS( "S" , type= 1 , graph=graph)



# sample usage on a problem : https://www.hackerrank.com/challenges/pacman-dfs 